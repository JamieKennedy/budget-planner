import { TSavings, TSavingsEdit } from '../../../../../../types/Savings';
...
const SavingsEditGoalForm = ({ item, closeFn }: ISavingsEditGoalFormProps) => {
    ...
    const onSubmit = (data: TSavingsEdit) => {
        updateSavings.mutate(data, {
            onSuccess: () => {
                closeFn();
            },
        });
    ...
    return (
        <div
            className={'border-2 border-gray-200 dark:border-blueMain dark:bg-dark dark:text-white bg-white rounded-2xl shadow-xl overflow-hidden max-w-xl w-full h-fit flex flex-col p-5 pb-10'}
            onClick={(e) => {
                e.stopPropagation();
            }}
        >
            <div className='flex flex-row items-center justify-between'>
                ...
                <button onClick={() => (updateSavings.status !== 'pending' ? closeFn() : null)}>
                ...
                <div className='h-fit pt-5'>
                    ...
                    <div className='mt-3'>
                        <FormSubmitButton
                            ...
                            formState={updateSavings.status}
